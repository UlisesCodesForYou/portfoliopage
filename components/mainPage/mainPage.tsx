            ...
            <section className="bg-gray-50 dark:bg-gray-800">
                ...
                <div className="mr-6 ml-6 bg-teal-600 shadow-xl shadow-teal-200-200 py-10 px-20 text-center">
                    <p className=" text-teal-600 ">
                        <span className="text-4xl font-medium text-white">Technologies</span> <br/> <span className="text-lg text-white">Below are a few examples of the the tehcnologies I have used along with the sites/apps I created using them.</span>
                    </p>
                </div>
                <div className="mr-6 ml-6 px-3 md:lg:xl:px-40 border-t border-b py-20 bg-opacity-10">
                    <div className="grid grid-cols-1 md:lg:xl:grid-cols-3 group bg-gray-50 shadow-xl shadow-neutral-100 border">
                        <div className="p-10 flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b hover:bg-slate-50 cursor-pointer">
                            ...
                            <p className="text-2xl font-medium mt-3 font-bold font-pageFont text-teal-600 ">
                                REACT and REACT Router
                            </p>
                            <p className="text-xl font-medium  font-bold font-pageFont text-teal-600 mt-3">
                                Cutlery Corner
                            </p>
                        ...
                        <div className="p-10 flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b hover:bg-slate-50 cursor-pointer">
                            ...
                            <p className="text-xl  font-bold font-pageFont text-teal-600 mt-3">
