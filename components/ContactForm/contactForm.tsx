...
export const ContactForm = () => {
  ...
  return (
    <>
      <section
        className="sm:m mt-52 bg-gradient-to-t from-teal-600 lg:mt-32"
        id="sayHello"
      >
          ...
          >
            ...
            <div>
              ...
              {emailInputHasError && (
                <p className="mt-2 animate-bounce text-xs italic text-red-800">
                  If you are seeing this bounce it means that you did not enter
                  a valid email. Please enter one.
                </p>
              )}
            </div>
            <div>
            ...
            <div className="sm:col-span-2">
              ...
              {enteredTextInputHasError && (
                <p className="mt-2 text-xs italic text-red-800">
                  Please leave me a message. I am so lonely!! Just kidding...or
                  am I?
                </p>
              )}
            </div>
      ...
      {/*<section className="sm:m mt-52 bg-white" id="sayHello">*/}
      {/*  <div className="mx-auto max-w-screen-md py-8 px-4 lg:py-16">*/}
      {/*    <h2 className="mb-4 text-center font-pageFont text-4xl font-extrabold tracking-tight text-[#343A40]">*/}
      {/*      Contact Me!*/}
      {/*    </h2>*/}
      ...
      {/*      <div className="container text-center">*/}
      {/*        <button*/}
      {/*            className="text-md badge-outline badge cursor-pointer rounded-full border-emerald-800 bg-emerald-300 py-4 px-9 font-pageFont tracking-wide text-black duration-300 hover:scale-110 lg:text-black lg:hover:bg-emerald-500 xl:mt-4"*/}
      {/*            disabled={!formIsValid}*/}
      {/*            onSubmit={formSubmissionHandler}*/}
      {/*            type="submit"*/}
      {/*        >*/}
