...
export const ContactForm = () => {
  ...
  return (
    <>
      ...
      {/*####### NEW CONTACT FORM ######*/}
      <div className="relative flex items-center py-5" id="sayHello">
      ...
      <section className="-mt-2 bg-white md:-mt-4">
        <div className="mx-auto max-w-screen-md py-8 px-4 lg:py-16">
          ...
          >
            ...
            <div className="container text-center">
              <button
                className="text-md badge-outline badge cursor-pointer rounded-full border-emerald-800 bg-emerald-300 py-4 px-9 font-pageFont tracking-wide text-black duration-300 hover:scale-110 disabled:opacity-30 sm:m-auto lg:text-black lg:hover:bg-emerald-500 xl:mt-4"
                disabled={!formIsValid}
                onSubmit={formSubmissionHandler}
                type="submit"
              >
